...
const ROLE_USER = 'ROLE_USER';       // tout le monde
const ROLE_ADMIN = 'ROLE_ADMIN';     // administrateur
const ROLE_OWNER = 'ROLE_PROPRIETAIRE';  // propriétaire
const ROLE_TENANT = 'ROLE_LOCATAIRE';   // locataire
